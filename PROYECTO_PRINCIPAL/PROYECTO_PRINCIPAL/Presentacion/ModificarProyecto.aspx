<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/GestionDeProyectos.master" AutoEventWireup="true" CodeBehind="ModificarProyecto.aspx.cs" Inherits="PROYECTO_PRINCIPAL.Presentacion.ModificarProyecto" %>
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td style="width: 236px">
                &nbsp;</td>
            <td colspan="2">
                <asp:Button ID="bnmodificar" runat="server" onclick="bnmodificar_Click" 
                    Text="MODIFICAR" class="btn btn-info"/>
            </td>
            <td>
                &nbsp;</td>
        </tr>
